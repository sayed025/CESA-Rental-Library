    ...
    <div class="container">
      ...
      if (isset($_POST['submit'])) {
        ...
        if (mysqli_num_rows($q) == 0) {
          echo "Sorry! No request found with that username. Try searching again.";
        } else {
      ...
      ?>
          <form method="post">
            ...
            <button class="btn btn-default" type="submit" name="submit1"> <span style="color: red;" class="glyphicon glyphicon-remove-sign"> </span> &nbsp Remove </button>
            <button class="btn btn-default" type="submit" name="submit2"> <span style="color: green;" class="glyphicon glyphicon-ok-sign"> </span> &nbsp Approve </button>
